...
class _HomePageState extends State<HomePage> {
  ...
  gettingUserData() async {
    ...
    await HelperFunctions.getUserNameFormSF().then((val) {
      setState(() {
        userName = val!;
      });
    });

    //gettingthe list of snapshots in out stream
                ...
                ElevatedButton(
                  onPressed: () async {
                    if (groupName != "") {
                      ...
                      Navigator.of(context).pop();
                      showSnackbar(
                          context, Colors.blue, "Group created successfully.");
                    }
                  },
            ...
            if (snapshot.data['groups'].length != 0) {
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  // ############# last to first groups order (reverse) ############
