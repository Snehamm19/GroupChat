...
class _SearchPageState extends State<SearchPage> {
  ...
  //             isJoined = !isJoined;
  //           });
  //           showSnackbar(context, Colors.blue, "Successfully joined the group");
  ...
  Future<void> joinedOrNot(
      String userName, String groupId, String groupName, String admin) async {
    bool value = await DatabaseService(uid: user!.uid)
        ...
        onTap: () async {
          ...
          if (isJoined) {
            setState(() {
              isJoined = !isJoined;
              showSnackbar(
                  context, Colors.blue, "Successfully joined the group");
            });
